        ...
        <div class="container">
            ...
            <div class="row g-0 team-items">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{asset/img/team-5.jpg}}" alt="">
                       </div>
                        <div class="bg-light text-center p-4">
                            <h3 class="mt-2">white dinner jacket</h3>
                            <span class="text-primary">Price : $200</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{asset/img/team-6.jpg}}" alt="">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h3 class="mt-2">linen blazer</h3>
                            <span class="text-primary">Price : $150</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{asset/img/team-7.jpg}}" alt="">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h3 class="mt-2">Sport Coat</h3>
                            <span class="text-primary">Price : $150</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{asset/img/team-8.jpg}}" alt="">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h3 class="mt-2">Tuxedo</h3>
                            <span class="text-primary">Price : $150</span>
